  ...
  <StyledSection className="main-section">
    <StyledContainer className="container">
      <StyledItem>
        <h5>Introduction</h5>
        <span>
          Saola Pty Ltd (BP), ABN: 641 511 604 is committed to treating the personal information we collect in accordance with the Australian Privacy Principles in the Privacy Act 1988 (Cth) (Privacy Act). This policy sets out how BP handles personal information.<br />
          This privacy policy does not apply to personal information collected by BP that is exempted under the Privacy Act, for example employee records.<br />
          Our privacy policy will be reviewed regularly to take account of changes in legislation, technology, and our operations and practices. We aim to ensure the policy is appropriate to the changing environment. We will inform you, via our website, of any changes we make to this privacy policy as necessary.<br />
      ...
      <StyledItem>
        <h5>Use of Data</h5>
        <span>
          Saola uses the collected data for various purposes:<br />
          <ul>
      ...
      <StyledItem>
        ...
        <span>
          ...
          Saola may disclose your Personal Data in the good faith belief that such action is necessary to:<br />
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Cuber Inc</li>
      ...
      <StyledItem>
        ...
        <span>
          ...
          <a href="https://policies.google.com/privacy?hl=en" target="_blank" rel="noreferrer">https://policies.google.com/privacy?hl=en</a>
        </span>
      </StyledItem>
      <StyledItem>
