        ...
        <StyledSection className="main-section">
            {
                PROJECTS_LIST.map((item, idx) => (
                    <StyledContainer key={idx} className="container">
                        <Row gutter={[0, 24]}>
                            <Col span={24} className="gs_reveal gs_reveal_fromRight">
                                <StyledImage src={item.image} alt={item.name} width={316} height={271} />
                            </Col>
                            <Col span={24} className="gs_reveal gs_reveal_fromLeft">
                                <StyledItem>
                                    ...
                                    <Row>
                                        <Col span={12}>
                                            <StyledItemWhat>
                                                <span className="gs_reveal">PROJECT SCOPE</span>
                                                {
                                                    item.whats.map((val) => (
                                        ...
                                        <Col span={12}>
                                            <StyledItemTimeLine>
                                                <span className="gs_reveal">PUBLISHED</span>
